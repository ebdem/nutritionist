        ...
        <>
            <nav className="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
                <div className="container">
                    ...
                    <a className="navbar-brand text-brand" href="index.html">Adıyaman<span
                        className="color-b">Diyetisyen</span></a>
                    ...
                    <button type="button" className="btn btn-b-n navbar-toggle-box-collapse d-none d-md-block"
                            data-toggle="collapse" data-target="#navbarTogglerDemo01" aria-expanded="false">
                        <span aria-hidden="true"> <FontAwesomeIcon icon={faSearch}/></span>
                    </button>
                </div>
            </nav>
